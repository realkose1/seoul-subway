...
/* 같은 trainNo가 피드에 여러 행으로 찍혀 있을 때(갱신 지연으로 남은 옛 위치) 최신 수신분만 남긴다.
   trainNo가 비어있는 행은 그대로 둔다. */

 ...
 *                                                     paused, last_push_at, last_feed_at, expires_at }
...
const apiKey = () =>
  process.env.SUPABASE_SERVICE_KEY || process.env.SUPABASE_ANON_KEY || process.env.SUPABASE_ANON_FALLBACK || "";
...
/* ── sf_cache ↔ 주행 행 매핑 ─────────────────────────────────────────────── */
const ROW_KEYS = ["trip_id", "token", "env", "attrs", "state", "track", "paused", "last_push_at", "last_feed_at", "expires_at"];
